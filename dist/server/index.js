...
function getDraftSecret() {
	return "4520a0af-e084-47ce-8fe8-f352b664887f";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "51ffbeff-eea9-4afc-8b76-0ef258aac2e3";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "51ffbeff-eea9-4afc-8b76-0ef258aac2e3") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "51ffbeff-eea9-4afc-8b76-0ef258aac2e3",
		rootBoundaryId
	});
}
/**
...
function Home() {
	return /* @__PURE__ */ (0, import_jsx_runtime_react_server.jsx)("main", { children: "Loading NodeShift v2…" });
}
